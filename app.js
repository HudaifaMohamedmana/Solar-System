...
const solarSystem = [
  ...
  console.log(system.mercury.mass)    
    ...
    system.jupiter.satellites=parseInt(system.jupiter.satellites);
    ...
    let JupiterMomentum = (system.jupiter.mass *system.jupiter.velocity);//    velocity: 13.06, mass: 317.89,
    let PlutoMomentum = (system.pluto.mass *system.pluto.velocity);//    velocity: 4.74,    mass: 0.002,
